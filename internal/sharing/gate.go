...
// GateSigner issues and verifies the short-lived, HMAC-signed cookie that proves a visitor passed a gated link's secret.
// The cookie binds to one token; opening a different gated link overwrites it.
